...
import type { Contributor as _Contributor, ExternalBlob as _ExternalBlob, Project as _Project, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getProjectsSnapshot(): Promise<{
        evolution: {
            added: Array<Project>;
            removed: Array<string>;
        };
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getProjectsSnapshot();
    ...
    async incrementAccessCount(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementAccessCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchProjectsByCategory(arg0: string): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchProjectsByCategory(arg0);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchProjectsByTag(arg0: string): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchProjectsByTag(arg0);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRepoForks(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRepoForks(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRepoStars(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRepoStars(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    description: string;
    repoUrl: string;
    contributors: Array<_Contributor>;
    downloads: bigint;
}): Promise<{
    id: string;
    categories: Array<string>;
    ...
    return {
        ...
        logo: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.logo)),
        name: value.name,
...
async function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        evolution: await from_candid_record_n22(_uploadFile, _downloadFile, value.evolution)
    };
}
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        added: await from_candid_vec_n13(_uploadFile, _downloadFile, value.added),
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Project>): Promise<Array<Project>> {
